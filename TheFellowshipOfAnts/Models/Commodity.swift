...
extension Commodity {
    static let dummy: [Commodity] = [
        Commodity(name: "Gold", price: "$1,702.40", fluctuationRate: "0.17%"),
        Commodity(name: "Silver", price: "$17.95", fluctuationRate: "0.03%"),
        Commodity(name: "Oil (WTI)", price: "$88.25", fluctuationRate: "2.34%"),
